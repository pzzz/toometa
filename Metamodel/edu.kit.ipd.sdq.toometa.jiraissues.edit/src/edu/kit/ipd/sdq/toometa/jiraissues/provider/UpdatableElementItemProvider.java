...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.toometa.jiraissues.UpdatableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdatableElementItemProvider extends IdentifierItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UpdatableElementItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns UpdatableElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UpdatableElement"));
	}
	...
	public String getText(Object object) {
		Date labelValue = ((UpdatableElement)object).getUpdateDate();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_UpdatableElement_type") :
			getString("_UI_UpdatableElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UpdatableElement.class)) {
