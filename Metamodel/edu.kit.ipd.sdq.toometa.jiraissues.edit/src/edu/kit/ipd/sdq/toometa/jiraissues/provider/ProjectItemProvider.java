...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.toometa.jiraissues.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider extends AddressableElementItemProvider {
	/**
	...
	protected void addKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_key_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_key_feature", "_UI_Project_type"),
				 JiraissuesPackage.Literals.PROJECT__KEY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
