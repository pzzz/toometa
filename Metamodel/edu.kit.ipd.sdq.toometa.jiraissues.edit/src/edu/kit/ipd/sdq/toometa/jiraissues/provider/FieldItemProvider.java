...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.toometa.jiraissues.Field} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FieldItemProvider extends IdentifierItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NamedelementPackage.Literals.NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addFieldIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Field_fieldId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Field_fieldId_feature", "_UI_Field_type"),
				 JiraissuesPackage.Literals.FIELD__FIELD_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JiraissuesPackage.Literals.FIELD__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Field_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Field_value_feature", "_UI_Field_type"),
				 JiraissuesPackage.Literals.FIELD__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
