...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.toometa.users.User} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserItemProvider extends IdentifierItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UsersPackage.Literals.USER__ROLES,
				 true,
				 false,
				 true,
				 null,
