...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.toometa.patterns.Keyword} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class KeywordItemProvider extends PropertyItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Keyword_keyword_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Keyword_keyword_feature", "_UI_Keyword_type"),
				 PatternsPackage.Literals.KEYWORD__KEYWORD,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Keyword)object).getKeyword();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Keyword.class)) {
			case PatternsPackage.KEYWORD__KEYWORD:
