...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.toometa.patterns.Goal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GoalItemProvider extends PropertyItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PatternsPackage.Literals.GOAL__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Goal.class)) {
			case PatternsPackage.GOAL__DESCRIPTION:
