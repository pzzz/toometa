...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.toometa.patterns.GeneralPatternDescription} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GeneralPatternDescriptionItemProvider 
	 ...
	 * @generated
	 */
	public GeneralPatternDescriptionItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((GeneralPatternDescription)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GeneralPatternDescription_type") :
			getString("_UI_GeneralPatternDescription_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GeneralPatternDescription.class)) {
			case PatternsPackage.GENERAL_PATTERN_DESCRIPTION__INFORMATION_SOURCE:
			case PatternsPackage.GENERAL_PATTERN_DESCRIPTION__SHORT_DESCRIPTION:
			case PatternsPackage.GENERAL_PATTERN_DESCRIPTION__DIAGRAM:
			case PatternsPackage.GENERAL_PATTERN_DESCRIPTION__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case PatternsPackage.GENERAL_PATTERN_DESCRIPTION__PROPERTY:
