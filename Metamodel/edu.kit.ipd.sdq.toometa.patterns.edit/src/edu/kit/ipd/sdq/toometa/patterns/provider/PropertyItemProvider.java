...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.toometa.patterns.Property} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyItemProvider extends IdentifierItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Property_terms_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Property_terms_feature", "_UI_Property_type"),
				 PatternsPackage.Literals.PROPERTY__TERMS,
				 true,
				 false,
				 true,
				 null,
