...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.toometa.patterns.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider extends IdentifierItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PatternsPackage.Literals.CATEGORY__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Category)object).getDescription();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Category.class)) {
			case PatternsPackage.CATEGORY__DESCRIPTION:
