...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>questions</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class QuestionsExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(QuestionsPackage.eNS_URI, 
			 QuestionsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.questions"));
				QuestionRepository root = QuestionsFactory.eINSTANCE.createQuestionRepository();
