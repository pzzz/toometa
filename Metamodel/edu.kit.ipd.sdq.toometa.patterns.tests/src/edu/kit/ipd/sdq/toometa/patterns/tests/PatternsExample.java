...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>patterns</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class PatternsExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.patterns"));
				Category root = PatternsFactory.eINSTANCE.createCategory();
