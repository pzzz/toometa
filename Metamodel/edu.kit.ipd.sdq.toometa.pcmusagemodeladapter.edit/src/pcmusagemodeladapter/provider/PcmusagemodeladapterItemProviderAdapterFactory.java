...
import edu.kit.ipd.sdq.toometa.requirements.util.RequirementsSwitch;
...
import pcmusagemodeladapter.util.PcmusagemodeladapterAdapterFactory;
 ...
 * @generated
 */
public class PcmusagemodeladapterItemProviderAdapterFactory extends PcmusagemodeladapterAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	/**
	 ...
	 * @generated
	 */
	public PcmusagemodeladapterItemProviderAdapterFactory() {
	...
	/**
	 * This keeps track of the one adapter used for all {@link pcmusagemodeladapter.PCMUsageModel} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected PCMUsageModelItemProvider pcmUsageModelItemProvider;

	/**
	 * This creates an adapter for a {@link pcmusagemodeladapter.PCMUsageModel}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createPCMUsageModelAdapter() {
		if (pcmUsageModelItemProvider == null) {
			pcmUsageModelItemProvider = new PCMUsageModelItemProvider(this);
		}

		return pcmUsageModelItemProvider;
	}
	 ...
	 */
	public void dispose() {
		if (pcmUsageModelItemProvider != null) pcmUsageModelItemProvider.dispose();
	}
				...
				newChildDescriptors.add
					(createChildParameter
						(DimensiontypesPackage.Literals.DIMENSION_TYPE_SCALE__SCALE_ELEMENTS,
						 PcmusagemodeladapterFactory.eINSTANCE.createPCMUsageModel()));
	...
	public static class RequirementsChildCreationExtender implements IChildCreationExtender {
		...
		protected static class CreationSwitch extends RequirementsSwitch<Object> {
			 ...
			 */
			@Override
			public Object caseUsageModelRepository(UsageModelRepository object) {
				newChildDescriptors.add
					(createChildParameter
