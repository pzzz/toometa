 ...
 * @generated
 */
public class IssuesSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IssuesPackage.ISSUE_MODEL: {
				IssueModel issueModel = (IssueModel)theEObject;
				T result = caseIssueModel(issueModel);
				if (result == null) result = caseIdentifier(issueModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IssuesPackage.ISSUE: {
				Issue issue = (Issue)theEObject;
				T result = caseIssue(issue);
				if (result == null) result = caseTraceableObject(issue);
				if (result == null) result = caseRelationObject(issue);
				if (result == null) result = caseConflictObject(issue);
				if (result == null) result = caseDuplicationObject(issue);
				if (result == null) result = caseDependencyObject(issue);
				if (result == null) result = caseParentalObject(issue);
				if (result == null) result = caseTriggerObject(issue);
				if (result == null) result = caseResolveObject(issue);
				if (result == null) result = caseAlternativeObject(issue);
				if (result == null) result = caseCouldResolveObject(issue);
				if (result == null) result = caseStakeholderObject(issue);
				if (result == null) result = caseSelectionObject(issue);
				if (result == null) result = caseIdentifier(issue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IssuesPackage.TEXT_ISSUE: {
				TextIssue textIssue = (TextIssue)theEObject;
				T result = caseTextIssue(textIssue);
				if (result == null) result = caseIssue(textIssue);
				if (result == null) result = caseTraceableObject(textIssue);
				if (result == null) result = caseRelationObject(textIssue);
				if (result == null) result = caseConflictObject(textIssue);
				if (result == null) result = caseDuplicationObject(textIssue);
				if (result == null) result = caseDependencyObject(textIssue);
				if (result == null) result = caseParentalObject(textIssue);
				if (result == null) result = caseTriggerObject(textIssue);
				if (result == null) result = caseResolveObject(textIssue);
				if (result == null) result = caseAlternativeObject(textIssue);
				if (result == null) result = caseCouldResolveObject(textIssue);
				if (result == null) result = caseStakeholderObject(textIssue);
				if (result == null) result = caseSelectionObject(textIssue);
				if (result == null) result = caseIdentifier(textIssue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Issue Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Issue Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIssueModel(IssueModel object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Text Issue</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Text Issue</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTextIssue(TextIssue object) {
		return null;
	}
