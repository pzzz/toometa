 ...
 * @generated
 */
public class PatternoptionsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PatternoptionsPackage.PATTERN_RATIONALE: {
				PatternRationale patternRationale = (PatternRationale)theEObject;
				T result = casePatternRationale(patternRationale);
				if (result == null) result = caseRationale(patternRationale);
				if (result == null) result = caseIdentifier(patternRationale);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PatternoptionsPackage.ANSWER: {
				Answer answer = (Answer)theEObject;
				T result = caseAnswer(answer);
				if (result == null) result = caseIdentifier(answer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PatternoptionsPackage.PATTERN_OPTION: {
				PatternOption patternOption = (PatternOption)theEObject;
				T result = casePatternOption(patternOption);
				if (result == null) result = caseOption(patternOption);
				if (result == null) result = caseTraceableObject(patternOption);
				if (result == null) result = caseRelationObject(patternOption);
				if (result == null) result = caseConflictObject(patternOption);
				if (result == null) result = caseDuplicationObject(patternOption);
				if (result == null) result = caseDependencyObject(patternOption);
				if (result == null) result = caseParentalObject(patternOption);
				if (result == null) result = caseTriggerObject(patternOption);
				if (result == null) result = caseResolveObject(patternOption);
				if (result == null) result = caseAlternativeObject(patternOption);
				if (result == null) result = caseCouldResolveObject(patternOption);
				if (result == null) result = caseStakeholderObject(patternOption);
				if (result == null) result = caseSelectionObject(patternOption);
				if (result == null) result = caseIdentifier(patternOption);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Pattern Rationale</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Pattern Rationale</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePatternRationale(PatternRationale object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePatternOption(PatternOption object) {
		return null;
	}
