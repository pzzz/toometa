 ...
 * @generated
 */
public class PatterninstancesSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PatterninstancesPackage.PATTERN_INSTANCE: {
				PatternInstance patternInstance = (PatternInstance)theEObject;
				T result = casePatternInstance(patternInstance);
				if (result == null) result = caseIdentifier(patternInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PatterninstancesPackage.CONNECTOR_INSTANCE: {
				ConnectorInstance connectorInstance = (ConnectorInstance)theEObject;
				T result = caseConnectorInstance(connectorInstance);
				if (result == null) result = caseIdentifier(connectorInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PatterninstancesPackage.ROLE_INSTANCE: {
				RoleInstance roleInstance = (RoleInstance)theEObject;
				T result = caseRoleInstance(roleInstance);
				if (result == null) result = caseIdentifier(roleInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PatterninstancesPackage.PATTERN_INSTANCE_REPOSITORY: {
				PatternInstanceRepository patternInstanceRepository = (PatternInstanceRepository)theEObject;
				T result = casePatternInstanceRepository(patternInstanceRepository);
				if (result == null) result = caseIdentifier(patternInstanceRepository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Pattern Instance Repository</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Pattern Instance Repository</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePatternInstanceRepository(PatternInstanceRepository object) {
		return null;
	}
