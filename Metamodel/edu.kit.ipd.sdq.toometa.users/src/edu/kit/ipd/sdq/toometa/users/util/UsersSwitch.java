...
public class UsersSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UsersPackage.USER_REPOSITORY: {
				UserRepository userRepository = (UserRepository)theEObject;
				T result = caseUserRepository(userRepository);
				if (result == null) result = caseIdentifier(userRepository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UsersPackage.ARCHITECT: {
				Architect architect = (Architect)theEObject;
				T result = caseArchitect(architect);
				if (result == null) result = caseRoleType(architect);
				if (result == null) result = caseIdentifier(architect);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UsersPackage.ENGINEER: {
				Engineer engineer = (Engineer)theEObject;
				T result = caseEngineer(engineer);
				if (result == null) result = caseRoleType(engineer);
				if (result == null) result = caseIdentifier(engineer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UsersPackage.USER: {
				...
				if (result == null) result = caseTraceableObject(user);
				if (result == null) result = caseRelationObject(user);
				if (result == null) result = caseConflictObject(user);
				if (result == null) result = caseDuplicationObject(user);
				if (result == null) result = caseDependencyObject(user);
				if (result == null) result = caseParentalObject(user);
				if (result == null) result = caseTriggerObject(user);
				if (result == null) result = caseResolveObject(user);
				if (result == null) result = caseAlternativeObject(user);
				if (result == null) result = caseCouldResolveObject(user);
				if (result == null) result = caseStakeholderObject(user);
				if (result == null) result = caseSelectionObject(user);
				if (result == null) result = caseIdentifier(user);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UsersPackage.ROLE_TYPE: {
			...
			case UsersPackage.REQ_ENGINEER: {
				ReqEngineer reqEngineer = (ReqEngineer)theEObject;
				T result = caseReqEngineer(reqEngineer);
				if (result == null) result = caseRoleType(reqEngineer);
				if (result == null) result = caseIdentifier(reqEngineer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UsersPackage.OTHER: {
				Other other = (Other)theEObject;
				T result = caseOther(other);
				if (result == null) result = caseRoleType(other);
				if (result == null) result = caseIdentifier(other);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseUserRepository(UserRepository object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Req Engineer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Req Engineer</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseReqEngineer(ReqEngineer object) {
		return null;
	}
