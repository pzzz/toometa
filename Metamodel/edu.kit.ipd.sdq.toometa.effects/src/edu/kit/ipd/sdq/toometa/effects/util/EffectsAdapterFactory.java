/**
 */
package edu.kit.ipd.sdq.toometa.effects.util;
...
public class EffectsAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected EffectsSwitch<Adapter> modelSwitch =
		new EffectsSwitch<Adapter>() {
			@Override
			public Adapter caseSimpleEffect(SimpleEffect object) {
				return createSimpleEffectAdapter();
			}
			@Override
			public Adapter caseEffectRepository(EffectRepository object) {
				return createEffectRepositoryAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseEffectCategory(EffectCategory object) {
				return createEffectCategoryAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseCategoryEffect(CategoryEffect object) {
				return createCategoryEffectAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.ipd.sdq.toometa.effects.SimpleEffect <em>Simple Effect</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.ipd.sdq.toometa.effects.EffectRepository <em>Effect Repository</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.ipd.sdq.toometa.effects.EffectCategory <em>Effect Category</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.ipd.sdq.toometa.effects.CategoryEffect <em>Category Effect</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
