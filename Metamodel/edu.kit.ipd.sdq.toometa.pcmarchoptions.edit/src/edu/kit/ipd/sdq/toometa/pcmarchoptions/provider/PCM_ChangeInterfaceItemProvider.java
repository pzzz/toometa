...
import edu.kit.ipd.sdq.toometa.archoptions.provider.ChangeInterfaceItemProvider;
...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.toometa.pcmarchoptions.PCM_ChangeInterface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PCM_ChangeInterface_oldInterface_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PCM_ChangeInterface_oldInterface_feature", "_UI_PCM_ChangeInterface_type"),
				 PcmarchoptionsPackage.Literals.PCM_CHANGE_INTERFACE__OLD_INTERFACE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNewInterfacePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PCM_ChangeInterface_newInterface_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PCM_ChangeInterface_newInterface_feature", "_UI_PCM_ChangeInterface_type"),
				 PcmarchoptionsPackage.Literals.PCM_CHANGE_INTERFACE__NEW_INTERFACE,
				 true,
				 false,
				 true,
				 null,
