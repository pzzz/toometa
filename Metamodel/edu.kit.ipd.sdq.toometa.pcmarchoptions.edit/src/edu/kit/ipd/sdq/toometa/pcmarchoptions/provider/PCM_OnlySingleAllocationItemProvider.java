...
import edu.kit.ipd.sdq.toometa.archoptions.provider.OnlySingleAllocationItemProvider;
...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.toometa.pcmarchoptions.PCM_OnlySingleAllocation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PCM_OnlySingleAllocation_allocationContext_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PCM_OnlySingleAllocation_allocationContext_feature", "_UI_PCM_OnlySingleAllocation_type"),
				 PcmarchoptionsPackage.Literals.PCM_ONLY_SINGLE_ALLOCATION__ALLOCATION_CONTEXT,
				 true,
				 false,
				 true,
				 null,
