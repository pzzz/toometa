...
import edu.kit.ipd.sdq.toometa.archoptions.provider.OnlySingleInstantiationItemProvider;
...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.toometa.pcmarchoptions.PCM_OnlySingleInstantiation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PCM_OnlySingleInstantiation_assemblyContext_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PCM_OnlySingleInstantiation_assemblyContext_feature", "_UI_PCM_OnlySingleInstantiation_type"),
				 PcmarchoptionsPackage.Literals.PCM_ONLY_SINGLE_INSTANTIATION__ASSEMBLY_CONTEXT,
				 true,
				 false,
				 true,
				 null,
