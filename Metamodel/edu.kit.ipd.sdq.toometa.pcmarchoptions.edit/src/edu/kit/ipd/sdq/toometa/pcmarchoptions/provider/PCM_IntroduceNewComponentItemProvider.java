...
import edu.kit.ipd.sdq.toometa.archoptions.provider.IntroduceNewComponentItemProvider;
...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.toometa.pcmarchoptions.PCM_IntroduceNewComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PCM_IntroduceNewComponent_assemblyContext_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PCM_IntroduceNewComponent_assemblyContext_feature", "_UI_PCM_IntroduceNewComponent_type"),
				 PcmarchoptionsPackage.Literals.PCM_INTRODUCE_NEW_COMPONENT__ASSEMBLY_CONTEXT,
				 true,
				 false,
				 true,
				 null,
