...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Scale Literal</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class ScaleLiteralTest extends ValueLiteralTest {
	...
	/**
	 * Constructs a new Scale Literal test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public ScaleLiteralTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this Scale Literal test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	protected ScaleLiteral<?> getFixture() {
		return (ScaleLiteral<?>)fixture;
	}
