...
public class QMLDeclarationsAdapterFactory extends AdapterFactoryImpl {
	...
	protected QMLDeclarationsSwitch<Adapter> modelSwitch =
		new QMLDeclarationsSwitch<Adapter>() {
			@Override
			public Adapter caseQMLDeclarations(QMLDeclarations object) {
				return createQMLDeclarationsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.dsexplore.qml.declarations.QMLDeclarations <em>QML Declarations</em>}'.
	 * <!-- begin-user-doc -->
