...
import de.uka.ipd.sdq.dsexplore.qml.declarations.*;
...
public class QMLDeclarationsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case QMLDeclarationsPackage.QML_DECLARATIONS: {
				QMLDeclarations qmlDeclarations = (QMLDeclarations)theEObject;
				T result = caseQMLDeclarations(qmlDeclarations);
				if (result == null) result = caseIdentifier(qmlDeclarations);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QMLDeclarationsPackage.QML_DECLARATION: {
				QMLDeclaration qmlDeclaration = (QMLDeclaration)theEObject;
				T result = caseQMLDeclaration(qmlDeclaration);
				if (result == null) result = caseIdentifier(qmlDeclaration);
				if (result == null) result = caseNamedElement(qmlDeclaration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseQMLDeclarations(QMLDeclarations object) {
		return null;
	}
