...
public class QMLDeclarationsPackageImpl extends EPackageImpl implements QMLDeclarationsPackage {
	 ...
	 * @see de.uka.ipd.sdq.dsexplore.qml.declarations.QMLDeclarationsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		qmlDeclarationEClass.getESuperTypes().add(theIdentifierPackage.getIdentifier());
		qmlDeclarationEClass.getESuperTypes().add(theNamedelementPackage.getNamedElement());
