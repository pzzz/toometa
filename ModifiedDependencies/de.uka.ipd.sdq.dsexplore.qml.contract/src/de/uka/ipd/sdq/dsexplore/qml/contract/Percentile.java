 ...
 * </p>
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.dsexplore.qml.contract.Percentile#getPercentile <em>Percentile</em>}</li>
 * </ul>
 *
 * @see de.uka.ipd.sdq.dsexplore.qml.contract.QMLContractPackage#getPercentile()
 * @model
 * @generated
 */
public interface Percentile extends PointEstimator {
	 ...
	 * @see de.uka.ipd.sdq.dsexplore.qml.contract.QMLContractPackage#getPercentile_Percentile()
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.dsexplore.qml.contract.Percentile#getPercentile <em>Percentile</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.percentile.oclAsType(Real) > 0.0 and self.percentile.oclAsType(Real) < 100.0'"
	 * @generated
	 */
