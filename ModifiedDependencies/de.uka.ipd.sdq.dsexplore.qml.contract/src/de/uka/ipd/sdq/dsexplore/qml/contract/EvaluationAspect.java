 ...
 * </p>
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.dsexplore.qml.contract.EvaluationAspect#getAspectRequirement <em>Aspect Requirement</em>}</li>
 * </ul>
 *
 * @see de.uka.ipd.sdq.dsexplore.qml.contract.QMLContractPackage#getEvaluationAspect()
 * @model abstract="true"
 * @generated
 */
public interface EvaluationAspect extends Identifier {
	 ...
	 * @see de.uka.ipd.sdq.dsexplore.qml.contract.QMLContractPackage#getEvaluationAspect_AspectRequirement()
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.dsexplore.qml.contract.EvaluationAspect#getAspectRequirement <em>Aspect Requirement</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
