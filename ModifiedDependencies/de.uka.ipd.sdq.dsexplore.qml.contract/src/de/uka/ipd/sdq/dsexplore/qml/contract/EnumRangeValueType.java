 ...
 * <!-- end-user-doc -->
 * @see de.uka.ipd.sdq.dsexplore.qml.contract.QMLContractPackage#getEnumRangeValueType()
 * @model
 * @generated
 */
public enum EnumRangeValueType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final EnumRangeValueType[] VALUES_ARRAY =
		new EnumRangeValueType[] {
			INCLUSIVE,
			EXCLUSIVE,
		};
	 ...
	 * @generated
	 */
	public static EnumRangeValueType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			EnumRangeValueType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static EnumRangeValueType get(int value) {
		switch (value) {
