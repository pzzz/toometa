 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.dsexplore.qml.dimensiontypes.Order#BIGGERELEMENT_must_not_be_SMALLELEMENT(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>BIGGERELEMENT must not be SMALLELEMENT</em>}</li>
 * </ul>
 * </p>
 * @generated
 */
public class OrderTest extends TestCase {
	...
	/**
	 * Tests the '{@link de.uka.ipd.sdq.dsexplore.qml.dimensiontypes.Order#BIGGERELEMENT_must_not_be_SMALLELEMENT(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>BIGGERELEMENT must not be SMALLELEMENT</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uka.ipd.sdq.dsexplore.qml.dimensiontypes.Order#BIGGERELEMENT_must_not_be_SMALLELEMENT(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
