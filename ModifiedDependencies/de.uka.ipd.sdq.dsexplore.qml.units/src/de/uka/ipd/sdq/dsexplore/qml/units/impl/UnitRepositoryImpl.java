 ...
 * </p>
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.dsexplore.qml.units.impl.UnitRepositoryImpl#getUnits <em>Units</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnitRepositoryImpl extends IdentifierImpl implements UnitRepository {
	...
	public EList<Unit> getUnits() {
		return (EList<Unit>)eDynamicGet(UnitsPackage.UNIT_REPOSITORY__UNITS, UnitsPackage.Literals.UNIT_REPOSITORY__UNITS, true, true);
	}
