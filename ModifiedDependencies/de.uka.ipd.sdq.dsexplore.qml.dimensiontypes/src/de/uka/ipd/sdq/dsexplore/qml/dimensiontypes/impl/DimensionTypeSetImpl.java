 ...
 * </p>
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.dsexplore.qml.dimensiontypes.impl.DimensionTypeSetImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.dsexplore.qml.dimensiontypes.impl.DimensionTypeSetImpl#getOrder <em>Order</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DimensionTypeSetImpl extends DimensionTypeImpl implements DimensionTypeSet {
	...
	public EList<Element> getElements() {
		return (EList<Element>)eDynamicGet(DimensiontypesPackage.DIMENSION_TYPE_SET__ELEMENTS, DimensiontypesPackage.Literals.DIMENSION_TYPE_SET__ELEMENTS, true, true);
	}
	...
	public EList<Order> getOrder() {
		return (EList<Order>)eDynamicGet(DimensiontypesPackage.DIMENSION_TYPE_SET__ORDER, DimensiontypesPackage.Literals.DIMENSION_TYPE_SET__ORDER, true, true);
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 DimensiontypesValidator.DIMENSION_TYPE_SET__ORDER_CAN_ONLY_EXIST_WITH_RELATIONSEMANTICS,
