...
public class DimensionsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DimensionsPackage.DIMENSION_REPOSITORY: {
				DimensionRepository dimensionRepository = (DimensionRepository)theEObject;
				T result = caseDimensionRepository(dimensionRepository);
				if (result == null) result = caseIdentifier(dimensionRepository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Dimension Repository</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Dimension Repository</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDimensionRepository(DimensionRepository object) {
		return null;
	}
