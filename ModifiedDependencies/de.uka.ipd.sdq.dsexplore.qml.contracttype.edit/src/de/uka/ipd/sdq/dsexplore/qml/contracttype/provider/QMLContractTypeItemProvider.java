...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.dsexplore.qml.contracttype.QMLContractType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QMLContractTypeItemProvider extends QMLDeclarationItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_QMLContractType_dimensions_feature", "_UI_QMLContractType_type"),
				 QMLContractTypePackage.Literals.QML_CONTRACT_TYPE__DIMENSIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((QMLContractType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_QMLContractType_type") :
