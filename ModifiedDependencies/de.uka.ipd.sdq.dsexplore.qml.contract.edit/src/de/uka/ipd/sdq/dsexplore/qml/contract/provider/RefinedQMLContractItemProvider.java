...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.dsexplore.qml.contract.RefinedQMLContract} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RefinedQMLContractItemProvider extends GenericQMLContractItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addBaseContractPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QMLContractPackage.Literals.REFINED_QML_CONTRACT__BASE_CONTRACT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QMLContractPackage.Literals.REFINED_QML_CONTRACT__REFINED_BY);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RefinedQMLContract"));
	}
	...
	public String getText(Object object) {
		String label = ((RefinedQMLContract)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_RefinedQMLContract_type") :
			getString("_UI_RefinedQMLContract_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RefinedQMLContract.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QMLContractPackage.Literals.REFINED_QML_CONTRACT__REFINED_BY,
