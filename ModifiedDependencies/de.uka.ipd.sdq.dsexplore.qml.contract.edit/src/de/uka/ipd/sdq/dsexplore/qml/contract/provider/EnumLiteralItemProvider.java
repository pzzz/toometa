...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.dsexplore.qml.contract.EnumLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumLiteralItemProvider extends ValueLiteralItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QMLContractPackage.Literals.ENUM_LITERAL__VALUE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((EnumLiteral)object).getId();
