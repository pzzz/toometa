...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.dsexplore.qml.contract.Criterion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CriterionItemProvider extends IdentifierItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Criterion_dimension_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Criterion_dimension_feature", "_UI_Criterion_type"),
				 QMLContractPackage.Literals.CRITERION__DIMENSION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QMLContractPackage.Literals.CRITERION__ASPECTS);
		}
	...
	public String getText(Object object) {
		String label = ((Criterion)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Criterion.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QMLContractPackage.Literals.CRITERION__ASPECTS,
