...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.dsexplore.qml.profile.UsageScenarioRequirement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UsageScenarioRequirementItemProvider extends RequirementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UsageScenarioRequirement_usageScenario_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UsageScenarioRequirement_usageScenario_feature", "_UI_UsageScenarioRequirement_type"),
				 ProfilePackage.Literals.USAGE_SCENARIO_REQUIREMENT__USAGE_SCENARIO,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_UsageScenarioRequirement_type") :
