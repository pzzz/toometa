...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.dsexplore.qml.profile.EntryLevelSystemCallRequirement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntryLevelSystemCallRequirementItemProvider extends RequirementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EntryLevelSystemCallRequirement_entryLevelSystemCall_feature", "_UI_EntryLevelSystemCallRequirement_type"),
				 ProfilePackage.Literals.ENTRY_LEVEL_SYSTEM_CALL_REQUIREMENT__ENTRY_LEVEL_SYSTEM_CALL,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_EntryLevelSystemCallRequirement_type") :
