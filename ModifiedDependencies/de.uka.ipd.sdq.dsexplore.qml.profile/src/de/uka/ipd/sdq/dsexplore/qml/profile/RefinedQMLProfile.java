 ...
 * </p>
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.dsexplore.qml.profile.RefinedQMLProfile#getBaseProfile <em>Base Profile</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.dsexplore.qml.profile.RefinedQMLProfile#getRefinedBy <em>Refined By</em>}</li>
 * </ul>
 *
 * @see de.uka.ipd.sdq.dsexplore.qml.profile.ProfilePackage#getRefinedQMLProfile()
 * @model
 * @generated
 */
public interface RefinedQMLProfile extends GenericQMLProfile {
	 ...
	 * @see de.uka.ipd.sdq.dsexplore.qml.profile.ProfilePackage#getRefinedQMLProfile_BaseProfile()
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.dsexplore.qml.profile.RefinedQMLProfile#getBaseProfile <em>Base Profile</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.uka.ipd.sdq.dsexplore.qml.profile.ProfilePackage#getRefinedQMLProfile_RefinedBy()
