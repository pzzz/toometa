...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>declarations</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class QMLDeclarationsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(QMLDeclarationsPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.qmldeclarations"));
				QMLDeclarations root = QMLDeclarationsFactory.eINSTANCE.createQMLDeclarations();
