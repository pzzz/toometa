...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>dimensions</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DimensionsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(DimensionsPackage.eNS_URI, 
			 DimensionsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.dimensions"));
				Dimension root = DimensionsFactory.eINSTANCE.createDimension();
